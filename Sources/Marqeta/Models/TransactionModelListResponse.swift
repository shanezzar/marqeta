//
// TransactionModelListResponse.swift
//
...
public struct TransactionModelListResponse: Codable {

    /** The number of resources to retrieve.  This field is returned if there are resources in your returned array. */
    public var count: Int?
    /** An array of transaction objects.  Objects are returned as appropriate to your query. */
    ...
    public init(count: Int? = nil, data: [TransactionModel]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
