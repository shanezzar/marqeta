//
// BulkCardOrderListResponse.swift
//
...
public struct BulkCardOrderListResponse: Codable {
    ...
    public var data: [BulkIssuanceResponse]?
    ...
    public init(count: Int? = nil, data: [BulkIssuanceResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
