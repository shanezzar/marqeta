//
// CardholderAddressListResponse.swift
//
...
public struct CardholderAddressListResponse: Codable {

    /** Number of resources to retrieve.  This field is returned if there are resources in your returned array. */
    public var count: Int?
    /** Array of address objects.  Objects are returned as appropriate to your query. */
    public var data: [CardholderAddressResponse]?
    ...
    public init(count: Int? = nil, data: [CardholderAddressResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
