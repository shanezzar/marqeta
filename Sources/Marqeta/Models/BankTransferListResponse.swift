...
public struct BankTransferListResponse: Codable {

    /** Number of resources retrieved.  This field is returned if there are resources in your returned array. */
    public var count: Int?
    /** Array of ACH transfer objects.  Objects are returned as appropriate to your query. */
    public var data: [BankTransferResponseModel]?
    ...
    public init(count: Int? = nil, data: [BankTransferResponseModel]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
