...
public struct CardListResponse: Codable {
    ...
    /** Array of card objects.  Objects are returned as appropriate to your query. */
    ...
    public init(count: Int? = nil, data: [CardResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
