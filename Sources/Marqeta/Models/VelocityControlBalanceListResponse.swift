//
// VelocityControlBalanceListResponse.swift
//
...
public struct VelocityControlBalanceListResponse: Codable {
    ...
    public var data: [VelocityControlBalanceResponse]?
    ...
    public init(count: Int? = nil, data: [VelocityControlBalanceResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
