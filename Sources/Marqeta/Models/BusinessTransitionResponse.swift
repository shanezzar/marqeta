//
// BusinessTransitionResponse.swift
//
...
public struct BusinessTransitionResponse: Codable {
    ...
    public init(businessToken: String? = nil, channel: Channel, createdTime: Date? = nil, lastModifiedTime: Date? = nil, reason: String? = nil, reasonCode: ReasonCode, status: Status, token: String) {
