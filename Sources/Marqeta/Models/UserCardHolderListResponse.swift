//
// UserCardHolderListResponse.swift
//
...
public struct UserCardHolderListResponse: Codable {
    ...
    public var data: [CardHolderModel]?
    ...
    public init(count: Int? = nil, data: [CardHolderModel]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
