//
// BankTransferTransitionListResponse.swift
//
...
public struct BankTransferTransitionListResponse: Codable {

    /** Number of resources retrieved.  This field is returned if there are resources in your returned array. */
    public var count: Int?
    /** Array of ACH transfer transition objects.  This field is returned if there are resources in your returned array. */
    public var data: [BankTransferTransitionResponseModel]?
    ...
    public init(count: Int? = nil, data: [BankTransferTransitionResponseModel]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
