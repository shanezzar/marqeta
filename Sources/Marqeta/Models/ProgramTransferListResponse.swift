//
// ProgramTransferListResponse.swift
//
...
public struct ProgramTransferListResponse: Codable {
    ...
    public var data: [ProgramTransferResponse]?
    ...
    public init(count: Int? = nil, data: [ProgramTransferResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
