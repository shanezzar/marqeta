...
public struct AuthControlListResponse: Codable {
    ...
    public var data: [AuthControlResponse]?
    ...
    public init(count: Int? = nil, data: [AuthControlResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
