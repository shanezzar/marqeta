//
// AccountHolderGroupListResponse.swift
//
...
public struct AccountHolderGroupListResponse: Codable {

    /** Number of resources to retrieve.  This field is returned if there are resources in your returned array. */
    public var count: Int?
    /** Array of account holder group objects.  Objects are returned as appropriate to your query. */
    public var data: [AccountHolderGroupResponse]?
    ...
    public init(count: Int? = nil, data: [AccountHolderGroupResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
