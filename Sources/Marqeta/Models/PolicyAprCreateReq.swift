...
public struct PolicyAprCreateReq: Codable {
    ...
    public init(_description: String? = nil, name: String, purchases: PolicyAprPurchaseReq, token: String? = nil) {
