...
public struct GPAUnloadListResponse: Codable {
    ...
    public init(count: Int? = nil, data: [GpaReturns]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
