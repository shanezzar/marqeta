//
// DigitalWalletAndroidPayProvisionRequest.swift
//
...
public struct DigitalWalletAndroidPayProvisionRequest: Codable {
    ...
    public init(cardToken: String, deviceId: String, deviceType: DeviceType, provisioningAppVersion: String, walletAccountId: String) {
