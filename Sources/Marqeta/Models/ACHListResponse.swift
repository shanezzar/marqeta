...
public struct ACHListResponse: Codable {

    /** Number of resources to retrieve.  This field is returned if there are resources in your returned array. */
    public var count: Int?
    /** Array of ACH funding source objects.  Objects are returned as appropriate to your query. */
    public var data: [BaseAchResponseModel]?
    ...
    public init(count: Int? = nil, data: [BaseAchResponseModel]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
