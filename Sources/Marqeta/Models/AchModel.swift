...
public struct AchModel: Codable {
    ...
    public init(accountNumber: String, accountType: AccountType, bankName: String? = nil, businessToken: String? = nil, isDefaultAccount: Bool? = nil, nameOnAccount: String, routingNumber: String, token: String? = nil, userToken: String? = nil, verificationNotes: String? = nil, verificationOverride: Bool? = nil) {
