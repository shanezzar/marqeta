...
public struct MsaAggregatedBalances: Codable {

    public var availableBalance: Decimal
    public var balances: [String:MsaAggregatedBalances]
    ...
    public init(availableBalance: Decimal, balances: [String:MsaAggregatedBalances], cachedBalance: Decimal, creditBalance: Decimal, currencyCode: String, impactedAmount: Decimal? = nil, lastUpdatedTime: Date, ledgerBalance: Decimal, pendingCredits: Decimal) {
