//
// DigitalWalletTokenTransitionListResponse.swift
//
...
public struct DigitalWalletTokenTransitionListResponse: Codable {
    ...
    public var data: [DigitalWalletTokenTransitionResponse]?
    ...
    public init(count: Int? = nil, data: [DigitalWalletTokenTransitionResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
