...
public struct MCCGroupListResponse: Codable {
    ...
    public init(count: Int? = nil, data: [MccGroupModel]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
