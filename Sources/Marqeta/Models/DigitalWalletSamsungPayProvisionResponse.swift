//
// DigitalWalletSamsungPayProvisionResponse.swift
//
...
public struct DigitalWalletSamsungPayProvisionResponse: Codable {
    ...
    public var pushTokenizeRequestData: SamsungPushTokenizeRequestData

    public init(cardToken: String, createdTime: Date, lastModifiedTime: Date, pushTokenizeRequestData: SamsungPushTokenizeRequestData) {
