//
// CardTransitionListResponse.swift
//
...
public struct CardTransitionListResponse: Codable {

    /** Number of resources to retrieve.  This field is returned if there are resources in your returned array. */
    public var count: Int?
    /** Array of card transition objects.  Objects are returned as appropriate to your query. */
    public var data: [CardTransitionResponse]?
    ...
    public init(count: Int? = nil, data: [CardTransitionResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
