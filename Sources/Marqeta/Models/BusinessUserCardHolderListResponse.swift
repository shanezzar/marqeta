//
// BusinessUserCardHolderListResponse.swift
//
...
public struct BusinessUserCardHolderListResponse: Codable {
    ...
    public var data: [UserCardHolderResponse]?
    ...
    public init(count: Int? = nil, data: [UserCardHolderResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
