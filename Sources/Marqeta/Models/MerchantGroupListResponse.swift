//
// MerchantGroupListResponse.swift
//
...
public struct MerchantGroupListResponse: Codable {

    /** Number of resources retrieved.  This field is returned if there are resources in your returned array. */
    public var count: Int?
    /** Array of merchant group resources.  Resources are returned as appropriate to your query. */
    public var data: [MerchantGroupResponse]?
    ...
    public init(count: Int? = nil, data: [MerchantGroupResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
