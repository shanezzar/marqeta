...
public struct UserTransitionRequest: Codable {
    ...
    public init(channel: Channel, idempotentHash: String? = nil, reason: String? = nil, reasonCode: ReasonCode, status: Status, token: String? = nil, userToken: String) {
