//
// UserTransitionListResponse.swift
//
...
public struct UserTransitionListResponse: Codable {
    ...
    public var data: [UserTransitionResponse]?
    ...
    public init(count: Int? = nil, data: [UserTransitionResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
