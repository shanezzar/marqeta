//
// ProgramReserveTransactionListResponse.swift
//
...
public struct ProgramReserveTransactionListResponse: Codable {
    ...
    public var data: [ProgramReserveTransactionResponse]?
    ...
    public init(count: Int? = nil, data: [ProgramReserveTransactionResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
