//
// CommandoModeListResponse.swift
//
...
public struct CommandoModeListResponse: Codable {
    ...
    public var data: [CommandoModeResponse]?
    ...
    public init(count: Int? = nil, data: [CommandoModeResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
