//
// BusinessTransitionListResponse.swift
//
...
public struct BusinessTransitionListResponse: Codable {
    ...
    public var data: [BusinessTransitionResponse]?
    ...
    public init(count: Int? = nil, data: [BusinessTransitionResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
