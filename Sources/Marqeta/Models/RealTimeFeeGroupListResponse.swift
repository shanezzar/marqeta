//
// RealTimeFeeGroupListResponse.swift
//
...
public struct RealTimeFeeGroupListResponse: Codable {
    ...
    public var data: [RealTimeFeeGroup]?
    ...
    public init(count: Int? = nil, data: [RealTimeFeeGroup]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
