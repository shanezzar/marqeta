...
public struct KYCListResponse: Codable {

    /** Number of resources in the returned array.  This field is returned if there are resources in your returned array. */
    public var count: Int?
    /** Array of KYC verification response objects.  Objects are returned as appropriate to your query. */
    public var data: [KycResponse]?
    ...
    public init(count: Int? = nil, data: [KycResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
