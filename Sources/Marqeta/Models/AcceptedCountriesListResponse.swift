//
// AcceptedCountriesListResponse.swift
//
...
public struct AcceptedCountriesListResponse: Codable {
    ...
    public var data: [AcceptedCountriesModel]?
    ...
    public init(count: Int? = nil, data: [AcceptedCountriesModel]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
