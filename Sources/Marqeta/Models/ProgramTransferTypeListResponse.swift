//
// ProgramTransferTypeListResponse.swift
//
...
public struct ProgramTransferTypeListResponse: Codable {
    ...
    public var data: [ProgramTransferTypeResponse]?
    ...
    public init(count: Int? = nil, data: [ProgramTransferTypeResponse]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
