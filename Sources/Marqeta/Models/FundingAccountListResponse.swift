//
// FundingAccountListResponse.swift
//
...
public struct FundingAccountListResponse: Codable {
    ...
    public var data: [FundingAccountResponseModel]?
    ...
    public init(count: Int? = nil, data: [FundingAccountResponseModel]? = nil, endIndex: Int? = nil, isMore: Bool? = nil, startIndex: Int? = nil) {
        self.count = count
        self.data = data
